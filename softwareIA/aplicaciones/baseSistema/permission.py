...
class IsRegisteredUser(permissions.BasePermission):
    required_groups = ['registered']

    def has_permission(self, request, view):
        has_group_permission = _has_group_permission(request.user, self.required_groups)
        return request.user and has_group_permission

class IsRegisteredVIPUser(permissions.BasePermission):
    required_groups = ['registeredVIP']
...
class NoHaveCompPerm(permissions.BasePermission):
    required_groups = ['admin']
